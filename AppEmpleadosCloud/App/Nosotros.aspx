<%@ Page Title="" Language="C#" MasterPageFile="~/App/Layout.Master" AutoEventWireup="true" CodeBehind="Nosotros.aspx.cs" Inherits="AppEmpleadosCloud.App.Nosotros" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <main class="estiloMain">
        <div class="contenedorCards">
                 ...
                 <div class="cards">
                    <div>
                        <img class="picProgramador" src="resources/images/Gal_Gadot.jpg" alt="">
                    </div>
                    <div>         
